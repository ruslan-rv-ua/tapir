...
- [nvda-player-transport-tab-order.md](docs/testing/nvda-player-transport-tab-order.md) — прогін для [player-transport-tab-order](docs/backlog/p2-player-transport-tab-order.md)
