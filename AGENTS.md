...
- [nvda-open-song-with-default-app.md](docs/testing/nvda-open-song-with-default-app.md) — прогін по відкриттю запису в зовнішній програмі та комбінаціях Alt+Enter / Ctrl+Enter (P1 open-song-with-default-app)
