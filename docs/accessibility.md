...
Прапорці, якими це зроблено в [StreamsPanel.tsx](../src/components/streams/StreamsPanel.tsx), — це
**запити, а не призначення**: у момент натиску ціль ще не змонтована, тож куди саме вести
фокус, вирішує ефект уже після заміни. Клас випадків, де це правило ще не виконується
(зона зникає від зміни статусу, а не від натиску), зібрано в
[backlog/p2-zone-vanishes-under-focus-audit.md](backlog/p2-zone-vanishes-under-focus-audit.md).
