...
6. **Обсяг — без винятків.** 200–400 слів на розділ, як усім, крім трьох названих у
   стиль-гайді. Калібрування: `overview` вийшов на 200 при дозволених 400, `navigation` —
...
8. **Шість змінних шаблону**, включно з `%n`. Підказка `settings_template_help`
   ...
   одного застосунку.
9. **Перехресні згадки — лише на наявні вкладки.** На момент злиття існують `overview`,
