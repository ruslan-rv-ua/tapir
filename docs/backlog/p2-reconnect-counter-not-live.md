...
summary: "пара «спроба N з M» їде правильним каналом, але канал не оновлюється під час запису; знахідка реалізації 2026-09-02, потрібен grooming каналу"
priority: P2
type: planned
status: draft
effort: S
...
notes:
  ...
  - "2026-09-08: перенесено з unscheduled у 0.1.1 — довідка recording.md обіцяє номер спроби, а 0.1.0 його не показує. Grooming каналу лишається перед кодом; варіанти всі всередині наявної події, IPC не міняється."
---
...
запис іде в **0.1.1**. Доти вада була про рідкісний випадок, тепер вона про звичайний,
а довідка обіцяє те, чого людина у випущеній версії не бачить.
