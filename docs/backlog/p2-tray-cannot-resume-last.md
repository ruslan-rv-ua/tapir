...
notes:
  ...
  - "2026-09-08: перенесено з 0.3.0 у 0.1.1 — це прогалина в уже обіцяній можливості, а не нова можливість: той самий жест із клавіатури працює. Розвилки лишаються відкритими, грилити перед кодом."
---
