...
notes:
  ...
  - "2026-09-24: дописано другий випадок того самого класу — `Ctrl+Shift+K`, коли останнього джерела не записано (знахідка grilling tray-cannot-resume-last §3)."
---
...
Рішення «чи відповідати» має накрити обидва випадки однаково. Якщо відповідь буде, для цього
випадку вона живе в `resume_last`, а не у вебв'ю: дія виконується в Rust, а за
