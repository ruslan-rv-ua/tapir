...
- [ ] `docs/help/` оновлено: `player.md` §«Гучність і позиція» називає відгук глобальних клавіш;
      ...
      Обидві локалі
- [ ] `Ctrl+Alt+Up/Down` дають відгук: одна репліка на жест, на відпусканні клавіші
- [ ] Утримання клавіші дає **одну** репліку — рівень, на якому відпустили, не серію
- [ ] Натискання на межі (100% вгору, 0% вниз) теж відповідає, а не мовчить
- [ ] Одинарний тап відповідає швидше за 100 мс — початкова затримка нарізана, не витримана цілком
- [ ] `Ctrl+M`, потім гучність вгору → чути рівень, а не «Звук вимкнено»
- [ ] Подвійної репліки немає при `Ctrl+M`, на зупинці, при старті з відновленням і при
      перемиканні профілю — жоден із цих шляхів події не шле
- [ ] На сфокусованому повзунку репліка одна — **перевірено прогоном**; якщо дубль чутно,
      придушити перевіркою `document.activeElement`
- [ ] `F9` називає рівень; на вимкненому звуці — стара клаузула, не обидві
