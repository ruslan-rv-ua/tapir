...
summary: "Відхилено: другого вікна не буде — ні WebView2 (~50 МБ), ні Win32-popup; фонова поверхня одна — трей із меню значка й глобальними клавішами."
priority: P3
type: idea
status: done
effort: L
...
з `OPEN-QUESTIONS.md`, секція P2 там спорожніла; сам файл знято 2026-09-08.
...
**Відхилено** (не реалізовано) — рішення розробника при розподілі по версіях. Спадок — межа, а
не код: **другого вікна в застосунку не буде** ні як другий WebView2 (~50 МБ RAM поверх
«portable single EXE»), ні як нативний Win32-popup із власним MSAA/UIA-деревом. Тому **фонова
поверхня одна — трей**: меню значка плюс глобальні клавіші лишаються єдиним способом керувати
Tapir, не піднімаючи вікно. Це підвищує ставку двох записів у 0.1.0:
[tray-layer-not-localized](p1-tray-layer-not-localized.md) (єдина фонова поверхня зобов'язана
бути двомовною — обхідного шляху більше немає) і
[sound-hotkeys-feedback-announce-only](p1-sound-hotkeys-feedback-announce-only.md) (відгук на
глобальні клавіші лишається balloon tips плюс видима поверхня у вікні). Сценарій «5–10 кроків,
щоб змінити дію з іншого застосунку» приймається як ціна — дешевшає він лише розширенням набору
глобальних клавіш. Усі чотири відкриті питання (клавіша, конфігурованість, друге Tauri-вікно
проти Win32, toggle) вилучено з OPEN-QUESTIONS — секція P2 там спорожніла
