...
- 🟦 **Форма пунктів-станцій** — розчеплено з `command-palette-taxonomy` (2026-07-23): фаза більше не залежить від неї; станції провізорні (див. вище), ядро — пісні+навігація.
