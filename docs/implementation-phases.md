...
> **Версія:** запланована на **0.2.0** (розподіл беклогу 2026-08-17). Робочий запис —
> [post-processing](backlog/p1-post-processing.md), оцінка переглянута M → L.
> Це остання незакрита фаза; 0.1.0 виходить із вкладкою «Постобробка» у стані
> `aria-disabled` з панеллю-поясненням.
