...
Tapir announces the start, the finish and every failure. The tray balloon for those follows **Notifications on track change** in the profile settings, on the **Interface** tab: despite its name, it governs schedule notifications too.
